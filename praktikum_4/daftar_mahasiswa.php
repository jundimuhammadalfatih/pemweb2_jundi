...
$mahasiswa1 = new Mahasiswa('Faiz Fikri', getRandomNim());
$mahasiswa2 = new Mahasiswa('Alissa Khairunnisa', getRandomNim());
$mahasiswa3 = new Mahasiswa('Rosaile Naurah', getRandomNim());
$mahasiswa4 = new Mahasiswa('Defghi Muhammad', getRandomNim());
